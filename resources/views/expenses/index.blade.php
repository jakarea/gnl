        ...
        <div class="page-bttn d-flex">
            ...
            <div class="common-bttn ms-3">
                <a href="#" type="button" class="add" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i
                        class="fas fa-plus"></i> Add Expenses</a>
            </div>
        </div>
        <!-- bttn -->
    </div>
            ...
            <div class="payment-from-copany-user expense-table">
                <div class="d-flex mb-15">
                    ...
                    <div class="actions">
                        ...
                        <a href="#" class="bttn" data-bs-toggle="modal" data-bs-target="#staticBackdropAdd"><i
                                class="fas fa-plus me-2"></i> Add Expenses</a>
                    </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6">
                    <div class="form-group form-error">
                      ...
                      <input type="text" placeholder="Service name" id="services_type" name="services_type"
                        class="form-control">
                    </div>
                  </div>
                  <div class="col-xl-6">
