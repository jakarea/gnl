        ...
        <div class="row">
            <div class="col-12 col-md-6 col-xl-4">
                <div class="customer-status-box">
                    ...
                    <div class="d-flex">
                        <span
                            class="{{ $projectStatus['completedComparePercentage'] < 0 ? 'lower' : '' }} ">{{ $projectStatus['completedComparePercentage'] }}%</span>
                        @php
                            $highLess = 'Higher';
                            if ($projectStatus['completedComparePercentage'] < 0) {
                                $highLess = 'Less';
                        } @endphp
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="customer-status-box">
                    ...
                    <div class="d-flex">
                        ...
                        @php
                            $highLess = 'Higher';
                            if ($projectStatus['inProgressComparePercentage'] < 0) {
                                $highLess = 'Less';
                        } @endphp
                        @if ($selectedQuery === 'this_month' || $selectedQuery === 'last_month')
                            <p>{{ $highLess }} than last
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="customer-status-box">
                    ...
                    <div class="d-flex">
                        ...
                        @php
                            $highLess = 'Higher';
                            if ($projectStatus['canceledComparePercentage'] < 0) {
                                $highLess = 'Less';
                        } @endphp
                        @if ($selectedQuery === 'this_month' || $selectedQuery === 'last_month')
                            <p>{{ $highLess }} than last
                        ...
                        @foreach ($topActiveCustomers->slice(0, 7) as $index => $topCustomer)
                            ...
                            <div class="media">
                                @if ($topCustomer->customer->avatar)
                                    <img src="{{ asset($topCustomer->customer->avatar) }}" alt="avatar"
                                ...
                                @if ($index == 0)
                                    <img src="{{ asset('assets/images/icons/trophy-1.svg') }}" alt="T"
                                        class="img-fluid">
                                @elseif ($index == 1)
                                    <img src="{{ asset('assets/images/icons/trophy-2.svg') }}" alt="T"
                                        class="img-fluid">
                                @else
                                    <img src="{{ asset('assets/images/icons/trophy-3.svg') }}" alt="T"
                                        class="img-fluid">
                                @endif
...
@section('script')
    ...
    <script>
        var getClientByPermonth = @json($getClientByPermonth);
        var options = {
            series: getClientByPermonth,
            chart: {
                height: 350,
                type: 'area',
                toolbar: {
