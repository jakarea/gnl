                    ...
                    <tbody>
                        ...
                        @foreach ($allLeads as $lead)
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><a
                                            href="{{ $lead->website ? $lead->website : '--' }}">{{ $lead->website ? $lead->website : '--' }}</a>
                                    </p>
                                </td>
                                <td>
                                    <p>99824254</p>
                                ...
                                <td>
                                    <div class="table-dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item lead-edit" href="#"
                                                data-id="{{ $lead->lead_id }}">Edit Lead</a>

                                            <form action="{{ route('lead.destroy', $lead->lead_id) }}" class="d-inline"
                                                method="POST">
                                                @csrf
...
<script>
    const getLeadType = (leadId,leadName) => {
        $("#lead_type_id2").val(leadId);
        $("#setLeadType2").html(leadName);
    }
</script>
