    ...
    <section class="main-page-wrapper analytics-page-wrapper">
        ...
        <div class="row mt-3">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xl-4 mb-4">
                <div class="analytics-card-box">
                    <div class="top">
                        <img src="{{ asset('assets/images/icons/profit.svg') }}" alt="I"
                            class="img-fluid money-recive">
                        <p>Total Profit</p>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xl-4 mb-4">
                <div class="analytics-card-box">
                    <div class="top">
                        <img src="{{ asset('assets/images/icons/user-add.svg') }}" alt="I"
                            class="img-fluid money-recive">
                        <p>Total Customer</p>
                    </div>
                    ...
                    <div class="d_grid">
                        <div class="pro-graph">
                            <div class="txt">
                                ...
                                <p><img src="{{ asset('assets/images/icons/arrow-up-gren.svg') }}" alt="a"
                                        class="img-fluid">
