                    ...
                    <div class="txt">
                        ...
                        <ul>
                            ...
                            @if ($user->personalInfo)
                                <li>
                                    <p><img src="{{ asset('/public/assets/images/icons/call.svg') }}" alt="I"
                                            class="img-fluid">
                    ...
                    <form action="{{ route('users.update', $user) }}" class="form-box" method="POST"
                        ...
                        <div class="form-group form-error">
                            ...
                            <input type="text" class="form-control @error('designation') is-invalid @enderror"
                                placeholder="Input here" value="{{ optional($user->personalInfo)->designation }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-error">
                                    ...
                                    <input type="date" class="form-control @error('dob') is-invalid @enderror"
                                        placeholder="Input here" value="{{ optional($user->personalInfo)->dob }}"
                                        name="dob" id="dob">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-error">
                                    ...
                                    <select name="gender" id="gender"
                                        ...
                                        <option value="Male"
                                            {{ optional($user->personalInfo)->gender == 'Male' ? 'selected' : '' }}>Male
                                        </option>
                                        <option value="Felame"
                                            {{ optional($user->personalInfo)->gender == 'Felame' ? 'selected' : '' }}>
                                            Female
                                        </option>
                                        <option value="Others"
                                            {{ optional($user->personalInfo)->gender == 'Others' ? 'selected' : '' }}>
                                            Others
                                        </option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-error">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        placeholder="Enter phone number" value="{{ optional($user->personalInfo)->phone }}"
                                        name="phone" id="phone">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-error">
                                    ...
                                    <input type="text" class="form-control @error('nationality') is-invalid @enderror"
                                        ...
                                        value="{{ optional($user->personalInfo)->nationality }}" name="nationality"
                                        id="nationality">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group form-error">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Input here status"
                                        value="{{ optional($user->personalInfo)->maritual_status }}"
                    ...
                    <div class="form-box mt-4">
                        <div class="title">
                            ...
                            <a href="{{ route('users.editAddress', $user->id) }}">
                                <img src="{{ asset('/public/assets/images/icons/pen.svg') }}" alt="I"
                                    class="img-fluid">
                            </a>
                        </div>
                        <!-- table start -->
