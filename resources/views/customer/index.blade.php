        ...
        <div class="all-customer-box mt-15">
                ...
                <div class="filters-area">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a class="dropdown-item active" href="#"
                          >All Leads <i class="fas fa-check"></i
                        ></a>
                      </li>
                      <li>
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a class="dropdown-item active" href="#"
                          >All Service <i class="fas fa-check"></i
                        ></a>
                      </li>
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a class="dropdown-item active" href="#"
                          >All Customer <i class="fas fa-check"></i
                        ></a>
                      </li>
                      <li>
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 mt-15">
              <div class="customer-person-box-wrap">
                <div class="avatar">
                  <img
                    src="./uploads/users/avatar-1.png"
                    alt="avatar"
                    class="img-fluid"
                  />
                </div>
          ...
          <div class="pagination-section">
            <nav class="mt-4" aria-label="...">
              <ul class="pagination">
                <li class="page-item">
                  <a class="page-link page-link-left"
                ...
                <li class="page-item">
                  <a class="page-link page-link-right" href="#"
                          ...
                          <div class="form-group">
                            ...
                            <div class="d-flex">
                              <label for="avatar" class="avatar">
                                <img
                                  src="./uploads/users/avatar-13.png"
                                  alt="avatar"
                                  class="img-fluid"
                                />
                              ...
                              <p>
                                <img
                                  src="./assets/images/icons/anchor.svg"
                                  alt="anchor"
                                  class="img-fluid"
                                />
                                Upload
                ...
                <div class="profile-header profile-header-address">
                  ...
                  <div class="profile-box profile-box-address">
                    ...
                    <div class="profile-edit-box profile-edit-details-box">
                      <img
                        class="img-fluid pen-tools"
                        src="./assets/images/icons/edit-1.svg"
                        alt="pen-images"
                      />
                      <img
                        class="img-fluid trash-tools"
                        src="./assets/images/icons/trash-1.svg"
                        alt="trash-images"
                      />
                    </div>
                  </div>
                        ...
                        <div class="filter-sort-box">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              <li>
                                <a
                                  class="dropdown-item filterItem"
                                  href="#"
                                  data-value="asc"
                                  >In order A-Z</a
                                >
