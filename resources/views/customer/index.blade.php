                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="{{ request()->input('leadTypeId') === $leadType ? 'active' : '' }}">
                                    <a class="dropdown-item"
                                        href="{{ route('customers.index', ['leadTypeId' => $leadType]) }}">{{
                                        $leadType->name }}</a>
                                </li>
                                @endforeach
                                @endif
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="{{ request()->input('searchTypeId') === $serviceType ? 'active' : '' }}">
                                    <a class="dropdown-item"
                                        href="{{ route('customers.index', ['searchTypeId' => $serviceType]) }}">{{
                                        $serviceType->name }}</a>
                                </li>
                                @endforeach
                                @endif
                    ...
                    <div class="actions">
                        ...
                        <div class="btn-group dropstart">
                            ...
                            <ul class="dropdown-menu dropdown-menu-start">
                                ...
                                <li>
                                    <a class="dropdown-item" href="javascript:;" onclick="deleteCustomer()">Delete
                                        Customer</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group form-error">
                                            ...
                                            <input type="text" placeholder="Enter location" id="location"
                                                name="location" class="form-control" value="{{ old('location') }}" />
                                            @error('location')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
