        ...
        <main class="root-main-wrapper">
            ...
            <aside class="sidebar-wrap custom-scroll-bar">
                ...
                <div class="side-navbar-wrap">
                    <ul class="side-nav">
                        <li class="side-item">
                            <a href="#" class="active side-link"><img
                                    src="{{ url('/assets/images/icons/sidebar/dashboard.svg') }}" alt="I"
                                    class="img-fluid">
                                Dashboard
                            </a>
                        </li>
                        <li class="side-item">
                            <a href="#" class="side-link"><img src="./assets/images/icons/sidebar/analytics.svg"
                                    alt="I" class="img-fluid" />
                                Analytics
                            </a>
                        </li>
                        <li class="side-item">
                            <a href="#" class="side-link"><img src="./assets/images/icons/sidebar/customer.svg"
                                    alt="I" class="img-fluid" />
                                Customer</a>
                        </li>
                        <li class="side-item">
                            <a href="#" class="side-link">
                                <img src="./assets/images/icons/sidebar/calendar.svg" alt="I"
                                    class="img-fluid" />
                                To Do List
                            </a>
                        </li>
                        <li class="side-item">
                            <a href="#" class="side-link"><img src="./assets/images/icons/sidebar/project.svg"
                                    alt="I" class="img-fluid" />
                                Project</a>
                        </li>
                        <li class="side-item side-subitem">
                            <a class="side-link" data-bs-toggle="collapse" href="#collapseExample" role="button"
                                ...
                                <img src="./assets/images/icons/sidebar/leads.svg" alt="I" class="img-fluid" />
                                Leads
                        ...
                        <li class="side-item side-subitem">
                            <a class="side-link" data-bs-toggle="collapse" href="#collapseExample2" role="button"
                                ...
                                <img src="./assets/images/icons/sidebar/earnings.svg" alt="I"
                                    class="img-fluid" />
                                Earning
                                <i class="fas fa-angle-down"></i>
                            </a>
                        ...
                        <li class="side-item">
                            <a href="#" class="side-link">
                                <img src="./assets/images/icons/sidebar/expense.svg" alt="I"
                                    class="img-fluid" />
                                Expenses</a>
                        </li>
                        <li class="side-item">
            ...
            <header class="header-area">
                ...
                <div class="header-search-box">
                    <img src="./assets/images/icons/search.svg" alt="S" class="img-fluid search" />
                    ...
                    <ul class="main">
                        <li class="head-item">
                            <a href="#" class="head-link">
                                <span></span>
                                <img src="./assets/images/icons/bell.svg" alt="B" class="img-fluid" />
                            </a>
                        </li>
                        <li class="head-item">
                            <div class="dropdown p-0 header-dropdown">
                                <a class="p-0 user head-link" href="#" role="button"
