    ...
    <main class="root-main-wrapper">
      ...
      <aside class="sidebar-wrap custom-scroll-bar">
        ...
        <div class="side-navbar-wrap">
          <ul class="side-nav">
            <li class="side-item">
                <a href="#" class="active side-link"><img src="{{ url('/assets/images/icons/sidebar/dashboard.svg') }}" alt="I"
                    class="img-fluid">
                  Dashboard
                </a>
            </li>
            <li class="side-item">
              <a href="#" class="side-link"
                ><img
                  src="./assets/images/icons/sidebar/analytics.svg"
                  alt="I"
                  class="img-fluid"
                />
                Analytics
            ...
            <li class="side-item">
              <a href="#" class="side-link"
                ><img
                  src="./assets/images/icons/sidebar/customer.svg"
                  alt="I"
                  class="img-fluid"
                />
                Customer</a
            ...
            <li class="side-item">
              <a href="#" class="side-link">
                <img
                  src="./assets/images/icons/sidebar/calendar.svg"
                  alt="I"
                  class="img-fluid"
                />
                To Do List
            ...
            <li class="side-item">
              <a href="#" class="side-link"
                ><img
                  src="./assets/images/icons/sidebar/project.svg"
                  alt="I"
                  class="img-fluid"
                />
                Project</a
            ...
            <li class="side-item side-subitem">
              ...
              >
                <img
                  src="./assets/images/icons/sidebar/leads.svg"
                  alt="I"
                  class="img-fluid"
                />
                Leads
            ...
            <li class="side-item side-subitem">
              ...
              >
                <img
                  src="./assets/images/icons/sidebar/earnings.svg"
                  alt="I"
                  class="img-fluid"
                />
                Earning
            ...
            <li class="side-item">
              <a href="#" class="side-link">
                <img
                  src="./assets/images/icons/sidebar/expense.svg"
                  alt="I"
                  class="img-fluid"
                />
                Expenses</a
          ...
          <ul class="main">
            ...
            <li class="head-item">
              <div class="dropdown p-0 header-dropdown">
                ...
                >
                  <img
                    src="./uploads/users/avatar-2.png"
                    alt="A"
                    class="img-fluid"
                  />
