                ...
                <div class="col-lg-7 border-start">
                    <div class="project-details-txt project-details-comment">
                        ...
                        <div class="project-single-comment mb-4">
                            <div class="media">
                                <img src="{{ url('uploads/users/avatar-9.png') }}" alt="a"
                                    class="img-fluid avatar" />
                                <div class="media-body">
                            ...
                            <ul>
                                <li>
                                    <a href="#"><img src="{{ url('assets/images/icons/like.svg') }}" alt="a"
                                            class="img-fluid" />
                                        <span>948</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ url('assets/images/icons/dislke.svg') }}" alt="a"
                                            class="img-fluid" />
                                        <span>182</span>
                                    </a>
                                </li>
                        ...
                        <div class="project-single-comment mb-4">
                            ...
                            <p class="comment-text">
                                Enim veritatis et neque sit voluptas ipsa perferendis. Voluptas accusamus dolorem dolore sit
                                incidunt.
                            </p>
                            <!-- comment action start -->
                            <ul>
                                <li>
                                    <a href="#" class="active"><img src="{{ url('/assets/images/icons/like.svg') }}"
                            ...
                            <div class="comment-reply-box">
                                ...
                                <div class="commment-reply-box">
                                    <p class="mb-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate
                                        veniam odio
                                    ...
                                    <button class="btn btn-submit" type="button"><img
                        ...
                        <div class="project-single-comment mb-4">
                            ...
                            <p class="comment-text">
                                Eveniet facilis et ab ut eos deserunt rerum. Mollitia provident necessitatibus non. Et sed
                                ipsam et non
                                omnis aut.
                            </p>
                            <!-- comment action start -->
                            <ul>
                                ...
                                <li>
                                    <a href="#"><img src="{{ url('/assets/images/icons/dislke.svg') }}"
                                            alt="a" class="img-fluid" />
                                        <span>182</span>
                                    </a>
                                </li>
                            ...
                            <div class="comment-reply-box">
                                ...
                                <div class="commment-reply-box">
                                    <p>
                                    <p>Doloremque et iure quas quidem ut quaerat voluptatum molestiae cum. Eaque quod
                                        necessitatibus rem
